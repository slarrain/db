...
class client:
    ...
    def openConnection(self):
        #conn_string = "host='localhost' dbname='lobbydb' user='santiago' password='sl2012le2187'"
        print "Opening a Connection"
        try:
            #self.conn = psycopg2.connect(conn_string)
            self.conn = psycopg2.connect(dbname='lobbydb')
            print "Connected"
        except:
    ...
    #Return True if not
    def check_loaded (self, rid, relation):
        print "a.1"
